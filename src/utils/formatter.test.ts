...
describe('formatAsText', () => {
  ...
  describe('object formatting', () => {
    it('should format object as key-value pairs', () => {
      ...
      const expected = 'timezone: America/New_York\ndatetime: 2023-12-07T10:30:00-05:00\nutc_offset: -05:00';
  ...
  describe('error handling', () => {
    it('should throw error for unsupported data types', () => {
      expect(() => formatAsText('string' as any)).toThrow('Unsupported data type for text formatting');
      expect(() => formatAsText(123 as any)).toThrow('Unsupported data type for text formatting');
      expect(() => formatAsText(null as any)).toThrow('Unsupported data type for text formatting');
    });
  });
});